...
NARRATIVE: dict[str, tuple[str, str]] = {
    ...
    "run28": (
        ...
        (
            ...
            "对照 run26 的五分之一损耗（十九次装配出十五版判决，四个回合没走到判决）；唯一一次上下文拦截来自修复提示词回显了"
    ...
    "run31": (
        ...
        (
            ...
            "多买四十张彩票，中奖标准就要相应提高）。四十回合出三十七版判决"
            "（二十九 null、五 blocked、三 candidate），三个回合没走到读取因而"
            ...
            "三条 candidate 与 run29 的那三条性质不同：方向判据已生效，"
            "它们的符号与自己声明的方向一致；但 |t| 分别为 2.194、2.021、2.020，"
            "全部低于各自读取时刻的本族地板 2.4771、2.5510、2.5824，"
            "属「闸门全过而效应微弱」。更要紧的是**三条出自同一条机制轴**"
